  ...
  ======================================================== -->
    <style>
        #header {
            ...
            transition: all 0.5s;
            padding: 0 15px;
            background-image: url('assets/img/<?= $data['sidebar'] ?>');
            overflow-y: auto;
        }
        ...
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <div class="social-links mt-3 text-center">
                    ...
                    if ($data['discord'] != "") {
                    ?>
                        <a href="<?= $data['discord'] ?>" class="google-plus"><i class="uil uil-discord"></i></a>
                    <?php
                    }
                    if ($data['linkedin'] != "") {
                    ?>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#portfolio"><i class="uil uil-briefcase-alt"></i> Services</a></li>
        ...
        <footer id="footer">
            ...
            <div class="copyright">
                <div class="footer_img">
                    <img src="assets/img/<?= $data['footer'] ?>" height="50px" width="50px">
                </div>
                <p>Copyright &copy; <script>
                        document.write(new Date().getFullYear())
                    </script><br>
                    <strong><span>Zaddy</span></strong> All Rights Reserved
                    <br> Developed by <a href="#">Gambhir Poudel</a>
                </p>
            </div>
