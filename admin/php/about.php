...
<form method="post" action="php/uabout.php">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="dob" value="<?= $data['dob'] ?>" class="form-control" id="dob" placeholder="17 August, 2002">
    </div>

    <div class="form-group col-md-6">
      <label for="website">Website</label>
      <input type="text" name="website" value="<?= $data['website'] ?>" class="form-control" id="website" placeholder="gambhirpoudel.com.np">
    </div>
  </div>
